 ...
 * @author Yassine
 */
public class GvAOmarController implements Initializable {
    ...
    @FXML
    private void GoAdress(MouseEvent event) throws IOException {
    ...
    @FXML
    private void ComAr(MouseEvent event) throws IOException {
    ...
    @FXML
    private void GoAv(MouseEvent event) throws IOException {
