...
public class AfficherRestauController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        sR.afficher().stream().forEach((p) -> {obsrestaulist.add(p);});
 ...
 //     typerestau.Items.clear();
    ...
    private void onUpdateRestau(ActionEvent event) {
      ...
      sR.modifier(new Restaurant(restau.getIdrestau(),nomrestau.getText(),typerestau.getSelectionModel().getSelectedItem().toString(),Integer.parseInt(nbrtable.getText()),localisation.getText(),Integer.parseInt(nbrtable.getText()),photo.getText()));
